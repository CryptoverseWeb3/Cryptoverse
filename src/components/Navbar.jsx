  ...
  return (
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          {[
            ...
            <a
              ...
              href="https://cryptoverseweb3.com"
              target={"_blank"}
            >
              Wallet
            </a>,
      ...
      >
        <a
          className={"text-white"}
          href="https://twitter.com/CryptoverseWeb3"
          target={"_blank"}
        >
        ...
        <a
          className={"text-white"}
          href="https://github.com/CryptoverseWeb3"
          target={"_blank"}
        >
        ...
        <a
          className={"text-white"}
          href="https://instagram.com/CryptoverseWeb3"
          target={"_blank"}
        >
        ...
        <a
          className={"text-white"}
          href="https://discord.gg/WhDry9FWE7"
          target={"_blank"}
        >
        ...
        <a
          className={"text-white"}
          href="https://t.me/cryptoverseweb3"
          target={"_blank"}
        >
        ...
        <a
          className={"text-white"}
          href="https://www.facebook.com/cryptoverseweb3"
          target={"_blank"}
        >
