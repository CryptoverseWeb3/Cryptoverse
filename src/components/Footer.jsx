    ...
    return (
        <div>
            ...
            <div className={"text-white md:flex hidden list-none flex-row justify-between items-center  text-white-600 hover:text-blue-800 visited:text-white-600 text-2xl"}>
                ...
                <a className={"text-white"} href="https://instagram.com/CryptoverseWeb3"><i className="social-icons ri-instagram-fill"></i></a>
                <a className={"text-white"} href="https://discord.gg/WhDry9FWE7"><i className="social-icons ri-discord-fill"></i></a>
                <a className={"text-white"} href="https://t.me/cryptoverseweb3"><i className="social-icons ri-telegram-line"></i></a>
                <a className={"text-white"} href="https://www.facebook.com/cryptoverseweb3"><i className="social-icons ri-facebook-fill"></i></a>
            </div>
        </div>
    );
};
